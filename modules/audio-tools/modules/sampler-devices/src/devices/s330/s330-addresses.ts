 ...
 * Tone N at [0x00, 0x03, N*4, 0x00] (stride of 4, same as patches)
 * Total size per tone: 256 bytes (512 nibbles)
 */
 ...
 *
 * Tone address layout (TONE_STRIDE = 4):
 * - Tone N at [0x00, 0x03, N*4, offset]
 * - Tone 0 at byte2=0, Tone 1 at byte2=4, etc.
 */
export function buildToneAddress(toneNumber: number, offset: number): number[] {
    const byte2 = toneNumber * 4;
